...
```
go get github.com/NeoclubTechnology/alipay/v3
```

```
import github.com/NeoclubTechnology/alipay/v3
```

##### 未启用 Go module

```
go get github.com/NeoclubTechnology/alipay
```

```
import github.com/NeoclubTechnology/alipay
```
